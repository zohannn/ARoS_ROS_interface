...
private:
	...
	//arm device pointer
	boost::shared_ptr<AmtecLWA7dof> arm;
	//hand device pointer
	boost::shared_ptr<BarrettHand826X> hand;
...
public:
	...
	void SetDevices(boost::shared_ptr<AmtecLWA7dof> arm_, boost::shared_ptr<BarrettHand826X> hand_);
