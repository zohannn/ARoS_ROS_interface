...
AmtecLWA7dof::AmtecLWA7dof( void )
...
, use_sync_motion( false )
{
	...
	*/
	std::string file_path = "UpperLimb/amtec_lwa_7dof/Init_Files/"; // configuration files
...
bool AmtecLWA7dof::open( int nGripper, int narm, bool use_sync_motion_ )
{
	if( narm == LEFT_ARM )
...
bool AmtecLWA7dof::getAxes( int *ax )
 {
	*ax = Number_of_Joints;
	return true;
 }

bool AmtecLWA7dof::positionMove( int j, double ref )
{
...
bool AmtecLWA7dof::positionMove( const double *refs )
{
	bool bSuccess = true;
...
bool AmtecLWA7dof::relativeMove( int j, double delta )
{
	float fPos = 0.0f;
...
bool AmtecLWA7dof::relativeMove( const double *deltas )
{
	bool bSuccess = true;
...
bool AmtecLWA7dof::setRefSpeed( int j, double sp )
{
...
bool AmtecLWA7dof::setRefSpeeds( const double *spds )
{
	bool bSuccess = true;
...
bool AmtecLWA7dof::setRefAcceleration( int j, double acc )
{
...
bool AmtecLWA7dof::setRefAccelerations( const double *accs )
{
	bool bSuccess = true;
...
bool AmtecLWA7dof::getRefSpeed( int j, double *ref )
{
	*ref = static_cast<double>( vec_RefSpeed[j] );
	return true;
}

bool AmtecLWA7dof::getRefSpeeds( double *spds )
{
	double dVal = 0.0;
...
bool AmtecLWA7dof::getRefAcceleration( int j, double *acc )
{
	*acc = static_cast<double>( vec_RefAcc[j] );
	return true;
}

bool AmtecLWA7dof::getRefAccelerations( double *accs )
{
	double dVal = 0.0;
...
bool AmtecLWA7dof::checkMotionDone( int j, bool *flag )
{
	*flag = Test_Joint_Flag( j, Amtec::Module::State::STAT_MOTION );
	return *flag;
}

bool AmtecLWA7dof::checkMotionDone( bool *flag )
{
	bool bDone = true;
...
bool AmtecLWA7dof::setVelocityMode()
{
	return false;
}

bool AmtecLWA7dof::velocityMove( int j, double sp )
{
...
bool AmtecLWA7dof::velocityMove( const double *sp )
{
	bool success = true;
...
bool AmtecLWA7dof::positionMove( int j, float ref, unsigned short time, bool wait_end )
{
...
bool AmtecLWA7dof::positionMoveSync(const float *refs, unsigned short time, bool wait_end)
{
	bool
		bSuccess = true;
...
bool AmtecLWA7dof::positionMove( float *refs, unsigned short time, bool wait_end )
{	
	bool 
		bSuccess = true,
		bEnd = false;
...
bool AmtecLWA7dof::positionMove( float *refs, bool *joints2move, unsigned short time, bool wait_end )
{
	bool bSuccess = true;
...
bool AmtecLWA7dof::positionMove( float * refs, unsigned short * times )
{
	bool bSuccess = true;
...
bool AmtecLWA7dof::positionMove( float * refs, unsigned short time, bool wait_end, float stop_margin )
{
	bool bSuccess = true;
...
bool AmtecLWA7dof::positionMove( float * refs, float fVel )
{
	float 
		fPos = 0.0f,
		fAux = 0.0f;
...
bool AmtecLWA7dof::positionMoveRamp( int j, float pos, float vel, float acc )
{
...
bool AmtecLWA7dof::positionMoveRamp( int j, float pos )
{
	float 
		fVel = 0.0f,
		fAcc = 0.0f;
...
bool AmtecLWA7dof::getPos( int nJoint, float * fPos )
{
...
bool AmtecLWA7dof::getPosAll( float * fPos )
{
...
bool AmtecLWA7dof::getPosDeg( int nJoint, float * fPos )
{
...
bool AmtecLWA7dof::getPosAllDeg( float * fPos )
{
...
bool AmtecLWA7dof::getVel( int nJoint, float * fVel )
{
...
bool AmtecLWA7dof::getMinLimit( int nJoint, float * fPos )
{
...
bool AmtecLWA7dof::getMaxLimit( int nJoint, float * fPos )
{
...
int AmtecLWA7dof::getNumberOfJoints( void )
{
...
bool AmtecLWA7dof::openGripper( unsigned short uiTime )
{
	int iGripper = 0;
...
bool AmtecLWA7dof::closeGripper( unsigned short uiTime )
{
	int iGripper = 0;
	if( bHasGripper ) iGripper = Number_of_Joints;
	else return false;
...
bool AmtecLWA7dof::moveGripperPos( float fPos, unsigned short uiTime )
{
	int iGripper = 0;
...
bool AmtecLWA7dof::getGripper( float *fPos )
{
	if( !bHasGripper )
		return false;
...
bool AmtecLWA7dof::freeJoint(int nJoint)
{
...
bool AmtecLWA7dof::waitMotionEnd( unsigned timeout_ms, int *state )
{
	int st = 0;
...
bool AmtecLWA7dof::waitMotionEnd( float * refs, float stop_margin )
{
	bool 
		bEnd = false,
		bSuccess = true;
...
int AmtecLWA7dof::get_force_torque(float *data)
{
	short state = 0;
...
bool AmtecLWA7dof::HomeJoint( int nJoint )
{
	int nCount = PCube_getModuleCount( nDevice );
...
bool AmtecLWA7dof::Home( std::vector<unsigned int> &home_order )
{
	bool 
		bHome = true,
		bAux = false;
...
bool AmtecLWA7dof::HomeAll( void )
{
...
bool AmtecLWA7dof::HomeGripper( void )
{
	if( nDevice < 0 ) 
		return false;
...
bool AmtecLWA7dof::Reset( int nJoint )
{
...
bool AmtecLWA7dof::ResetAll( void )
{
...
unsigned long AmtecLWA7dof::Get_Joint_State( int nJoint )
{
...
unsigned char AmtecLWA7dof::Get_Joint_Type( int nJoint )
{
...
bool AmtecLWA7dof::Test_Joint_Flag( int nJoint, unsigned long ulFlag )
{
	unsigned long state = 0;
...
bool AmtecLWA7dof::Test_Flag( unsigned long ulState, unsigned long ulFlag )
{
	return ( ( ulState & ulFlag ) == ulFlag );
}

bool AmtecLWA7dof::Test_Module( int nModule )
{
	//update Module state
...
bool AmtecLWA7dof::isArmStatusOK( void )
{
	//reset flags
	if( !ResetAll() )
		return false;
...
bool AmtecLWA7dof::are_Modules_OK( void )
{
...
bool AmtecLWA7dof::is_Module_OK( int joint )
{
...
bool AmtecLWA7dof::SoftStop( void )
{
	if( !stop() )
		return false;
...
int AmtecLWA7dof::Get_Error_Code( void )
{
	return error_code_;
}

std::string AmtecLWA7dof::Get_Error_Str( void )
{
	switch ( error_code_ )
	{
...
bool AmtecLWA7dof::Restart_Module()
{
...
std::string AmtecLWA7dof::Get_Error_Function_String( unsigned long ulError )
{
	return Get_Error_Function_String( static_cast<int>( ulError ) );
}

std::string AmtecLWA7dof::Get_Error_Function_String( int error )
{
...
bool AmtecLWA7dof::Update_State_Configuration( int nJoint )
{
...
bool AmtecLWA7dof::Update_State_Info( int nJoint )
{
...
bool AmtecLWA7dof::Update_State_Error( int nJoint )
{
