#include "../include/AmtecPStepServer.h"
...
#define	AMTEC_PSTEPSERVER_PATH	"UpperLimb/Amtec_PStepServer/bin/"
...
#pragma warning ( default : 4996 )
	...
	/*
	std::string	strAmtecStepServer = "";	
	std::string strAmtecStepServer_Path = getenv( "MAINPROJECT" );
	...
	*/
	std::string strAmtecStepServer_Path = AMTEC_PSTEPSERVER_PATH;
	std::string strAmtecStepServer = strAmtecStepServer_Path + AMTEC_PSTEPSERVER_EXE;
