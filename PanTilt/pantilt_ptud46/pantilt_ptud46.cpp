...
PanTilt_PTUD46::PanTilt_PTUD46( void )
...
bool PanTilt_PTUD46::isOpen( void )
{
	return bOpened;
}

inline void PanTilt_PTUD46::Print_Error( int error_code )
{
	std::cerr << PanTilt::Error::Text[ error_code ] << std::endl;
}

inline void PanTilt_PTUD46::Print_Error_str( int error_code, std::string strExtra )
{
	std::cerr << PanTilt::Error::Text[ error_code ] << strExtra << std::endl;
}

inline void PanTilt_PTUD46::Print_Error_int( int error_code, int val )
{
	std::cerr << PanTilt::Error::Text[ error_code ] << val << std::endl;
}

bool PanTilt_PTUD46::Read_Reply( std::string& sReply )
{
...
bool PanTilt_PTUD46::Read_Reply_Discard( void )
{
...
bool PanTilt_PTUD46::Write_Command( std::string command )
{
...
inline bool PanTilt_PTUD46::Write_Command_Discard_Reply( std::string command )
{
...
inline bool PanTilt_PTUD46::Write_Command_Discard_Reply( int axis, char command_ID )
{
...
inline bool PanTilt_PTUD46::Write_Command_send_1_Parameter( int axis, char command_ID, double value )
{
	if( !isValidAxis( axis ) ) return false;
...
inline bool PanTilt_PTUD46::Write_Command_receive_1_Parameter( int axis, char command_ID, double * value, std::string find_str )
{
	if( !isValidAxis( axis ) ) return false;
...
bool PanTilt_PTUD46::isValidAxis( int axis )
{
...
bool PanTilt_PTUD46::open( std::string sCom, int nBaudRate )
{
	//Default values for resolution
	dResolution.assign( nAxis, 190.5882 / 3600.0 );
...
bool PanTilt_PTUD46::close( void )
{
	bOpened = false;
...
//-------------------------------------------------------------------------------------------------
// Limit accessors
void PanTilt_PTUD46::set_AngleLimitMax_Pan( double val )
{
	dAngleLimit_Pan.at( MAX ) = val;
}

void PanTilt_PTUD46::set_AngleLimitMin_Pan( double val )
{
	dAngleLimit_Pan.at( MIN ) = val;
}

void PanTilt_PTUD46::set_AngleLimitMax_Tilt( double val )
{
	dAngleLimit_Tilt.at( MAX ) = val;
}

void PanTilt_PTUD46::set_AngleLimitMin_Tilt( double val )
{
	dAngleLimit_Tilt.at( MIN ) = val;
}

void PanTilt_PTUD46::set_SpeedLimitMax_Pan( double val )
{
	dSpeedLimit_Pan.at( MAX ) = val;
}

void PanTilt_PTUD46::set_SpeedLimitMin_Pan( double val )
{
	dSpeedLimit_Pan.at( MIN ) = val;
}

void PanTilt_PTUD46::set_SpeedLimitMax_Tilt( double val )
{
	dSpeedLimit_Tilt.at( MAX ) = val;
}

void PanTilt_PTUD46::set_SpeedLimitMin_Tilt( double val )
{
	dSpeedLimit_Tilt.at( MIN ) = val;
}

double PanTilt_PTUD46::get_AngleLimitMax_Pan( void )
{
	double val = dAngleLimit_Pan.at( MAX );
	return val;
}

double PanTilt_PTUD46::get_AngleLimitMin_Pan( void )
{
	double val = dAngleLimit_Pan.at( MIN );
	return val;
}

double PanTilt_PTUD46::get_AngleLimitMax_Tilt( void )
{
	double val = dAngleLimit_Tilt.at( MAX );
	return val;
}

double PanTilt_PTUD46::get_AngleLimitMin_Tilt( void )
{
	double val = dAngleLimit_Tilt.at( MIN );
	return val;
}

double PanTilt_PTUD46::get_SpeedLimitMax_Pan( void )
{
	double val = dSpeedLimit_Pan.at( MAX );
	return val;
}

double PanTilt_PTUD46::get_SpeedLimitMin_Pan( void )
{
	double val = dSpeedLimit_Pan.at( MIN );
	return val;
}

double PanTilt_PTUD46::get_SpeedLimitMax_Tilt( void )
{
	double val = dSpeedLimit_Tilt.at( MAX );
	return val;
}

double PanTilt_PTUD46::get_SpeedLimitMin_Tilt( void )
{
...
bool PanTilt_PTUD46::getAxes( int *ax )
{
	*ax = nAxis;
	return true;
}
...
bool PanTilt_PTUD46::getAxisName( int axis, std::string& name )
{
	if( !isValidAxis( axis ) ) return false;
...
bool PanTilt_PTUD46::setPositionModeRaw( void )
{
...
bool PanTilt_PTUD46::positionMoveRaw( int j, double ref )
{
	return Write_Command_send_1_Parameter( j, 'P', ref );
}

bool PanTilt_PTUD46::positionMoveRaw( const double *refs )
{
	for( int i=0 ; i<nAxis ; i++ ) 
...
bool PanTilt_PTUD46::relativeMoveRaw( int j, double delta )
{
	return Write_Command_send_1_Parameter( j, 'O', delta );
}

bool PanTilt_PTUD46::relativeMoveRaw( const double *deltas )
{
	for( int i=0 ; i<nAxis ; i++ ) 
...
bool PanTilt_PTUD46::checkMotionDoneRaw( int j, bool *flag )
{
	// Not available
	return false;
}

bool PanTilt_PTUD46::checkMotionDoneRaw( bool *flag )
{
	bool bFlag = true;
...
bool PanTilt_PTUD46::waitMotionDone( void )
{
...
bool PanTilt_PTUD46::setRefSpeedRaw( int j, double sp )
{
	return Write_Command_send_1_Parameter( j, 'S', sp );
}

bool PanTilt_PTUD46::setRefSpeedsRaw( const double *spds )
{
	for( int i=0 ; i<nAxis ; i++ ) 
...
bool PanTilt_PTUD46::setRefAccelerationRaw( int j, double acc )
{
	return Write_Command_send_1_Parameter( j, 'A', acc );
}

bool PanTilt_PTUD46::setRefAccelerationsRaw( const double *accs )
{
	for( int i=0 ; i<nAxis ; i++ ) 
...
bool PanTilt_PTUD46::getPositionRaw( int j, double *ref )
{
	return Write_Command_receive_1_Parameter( j, 'P', ref );
}

bool PanTilt_PTUD46::getPositionsRaw( double *refs )
{
	for( int i=0 ; i<nAxis ; i++ ) 
...
bool PanTilt_PTUD46::getRefSpeedRaw( int j, double *ref )
{
	return Write_Command_receive_1_Parameter( j, 'S', ref );
}

bool PanTilt_PTUD46::getRefSpeedsRaw( double *spds )
{
	for( int i=0 ; i<nAxis ; i++ ) 
...
bool PanTilt_PTUD46::getRefAccelerationRaw( int j, double *acc )
{
	return Write_Command_receive_1_Parameter( j, 'A', acc );
}

bool PanTilt_PTUD46::getRefAccelerationsRaw( double *accs )
{
	for( int i=0 ; i<nAxis ; i++ ) 
...
bool PanTilt_PTUD46::stopRaw( int j )
{
	return Write_Command_Discard_Reply( j, 'H' );
}

bool PanTilt_PTUD46::stopRaw( void )
{
...
bool PanTilt_PTUD46::setPositionMode()
{
	return setPositionModeRaw();
}

bool PanTilt_PTUD46::positionMove( int j, double ref )
{
	return positionMoveRaw( j, ref/dResolution.at( j ) );
}

bool PanTilt_PTUD46::positionMove( const double *refs )
{
...
bool PanTilt_PTUD46::relativeMove( int j, double delta )
{
	return relativeMoveRaw( j, delta/dResolution.at( j ) );
}

bool PanTilt_PTUD46::relativeMove( const double *deltas )
{
...
bool PanTilt_PTUD46::checkMotionDone( int j, bool *flag )
{
	return checkMotionDoneRaw( j, flag );
}

bool PanTilt_PTUD46::checkMotionDone( bool *flag )
{
	return checkMotionDoneRaw( flag );
}

bool PanTilt_PTUD46::setRefSpeed( int j, double sp )
{
	return setRefSpeedRaw( j, sp/dResolution.at( j ) );
}

bool PanTilt_PTUD46::setRefSpeeds( const double *spds )
{
...
bool PanTilt_PTUD46::setRefAcceleration( int j, double acc )
{
	return setRefAccelerationRaw( j, acc/dResolution.at( j ) );
}

bool PanTilt_PTUD46::setRefAccelerations( const double *accs )
{
...
bool PanTilt_PTUD46::getPosition( int j, double *ref )
{
...
bool PanTilt_PTUD46::getPositions( double *refs)
{
...
bool PanTilt_PTUD46::getRefSpeed( int j, double *ref )
{
...
bool PanTilt_PTUD46::getRefSpeeds( double *spds)
{
...
bool PanTilt_PTUD46::getRefAcceleration( int j, double *acc )
{
...
bool PanTilt_PTUD46::getRefAccelerations( double *accs )
{
...
bool PanTilt_PTUD46::stop( int j )
{
	return stopRaw( j );
}

bool PanTilt_PTUD46::stop( void )
{
	return stopRaw();
}
...
bool PanTilt_PTUD46::setVelocityModeRaw( void )
{
...
bool PanTilt_PTUD46::velocityMoveRaw( int j, double sp )
{
...
bool PanTilt_PTUD46::velocityMoveRaw( const double *sp )
{
	if( nControlMode != PanTilt::ControlMode::VELOCITY )
	{
...
bool PanTilt_PTUD46::velocityMoveRelativeRaw( int j, double sp )
{
	if( nControlMode != PanTilt::ControlMode::VELOCITY )
		if( !setVelocityModeRaw() ) return false;
...
bool PanTilt_PTUD46::velocityMoveRelativeRaw( const double *spds )
{
	for( int i=0 ; i<nAxis ; i++ ) 
...
bool PanTilt_PTUD46::setVelocityMode( void )
{
	return setVelocityModeRaw();
}

bool PanTilt_PTUD46::velocityMove( int j, double sp )
{
	return velocityMoveRaw( j, sp/dResolution.at( j ) );
}

bool PanTilt_PTUD46::velocityMove( const double *spds )
{
	double dSpds[PanTilt::Axis::ID::PANTILT_NUMBER_OF_AXES];
...
bool PanTilt_PTUD46::velocityMoveRelative( int j, double sp )
{
	return velocityMoveRelativeRaw( j, sp );
}

bool PanTilt_PTUD46::velocityMoveRelative( const double *spds )
{
	double dSpds[PanTilt::Axis::ID::PANTILT_NUMBER_OF_AXES];
...
bool PanTilt_PTUD46::reset( int j )
{
	return Write_Command_Discard_Reply( j, 'R' );
}

bool PanTilt_PTUD46::reset()
{
