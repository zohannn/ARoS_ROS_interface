...
CCommunicationServerPanTilt::CCommunicationServerPanTilt( const std::string name, const std::string dev_config_file )
...
CCommunicationServerPanTilt::~CCommunicationServerPanTilt( void )
{
}

bool CCommunicationServerPanTilt::Init( void )
{
...
void CCommunicationServerPanTilt::Fini( void )
{
	PanTilt.close();
	//PanTilt_Properties.clear();
}

void CCommunicationServerPanTilt::ConvertCoordinatestoPanTilt( float fCoord[3], float *fPanTilt )
{
	const float
		fX = fCoord[0], 
		fY = fCoord[1], 
...
inline void CCommunicationServerPanTilt::Print_Wrapper_Error( int error_code )
{
	std::cerr << PanTiltWrapper::Error::Wrapper_Error_Prefix << PanTiltWrapper::Error::Text[ error_code ] << std::endl;
}

inline void CCommunicationServerPanTilt::Print_Wrapper_Error( int error_code, std::string strExtra )
{
	std::cerr << PanTiltWrapper::Error::Wrapper_Error_Prefix << PanTiltWrapper::Error::Text[ error_code ] << strExtra << std::endl;
}

inline void CCommunicationServerPanTilt::Print_Wrapper_Error( int error_code, int command )
{
...
/*
std::string CCommunicationServerPanTilt::CommandToString( unsigned int uCommand )
{
